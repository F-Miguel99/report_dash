...
def sidebar_menu():
    ...
    st.sidebar.page_link("pages/10_📝_PEPs_OPs.py,", disabled=st.session_state.username)
    st.sidebar.page_link("pages/8_🏦_BET_Enterprises.py", disabled=st.session_state.username)
    st.sidebar.page_link("pages/11_🔢_Accounts_and_Balances.py", disabled=st.session_state.username)
    st.sidebar.page_link("pages/9_📝_Transactions.py", disabled=st.session_state.username)
